...
## Notes:
**this works, although not sure how to enable gunicorn web server via pypi package. pretty sure there isn't a way, so i'll proabably use docker + start.sh.**

**source code of branch deploy-beta**
